...
const PROVENANCE_LABEL_KEYS: Record<ProvenanceType, TranslationKey> = {
  genesis: 'badgeGenesis',
  hybrid: 'badgeHybrid',
  echo: 'badgeEcho',
};

const PROVENANCE_TOOLTIP_KEYS: Record<ProvenanceType, TranslationKey> = {
  genesis: 'badgeGenesisTooltip',
  hybrid: 'badgeHybridTooltip',
  echo: 'badgeEchoTooltip',
};
...
export function ProvenanceBadge({
  ...
  return (
    <span className={cn('group relative inline-flex shrink-0 align-middle', className)}>
      ...
      >
        {t(PROVENANCE_TOOLTIP_KEYS[type])}
      </span>
    </span>
  );
}
